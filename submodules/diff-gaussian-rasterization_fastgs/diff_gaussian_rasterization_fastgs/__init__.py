...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            num_rendered, num_buckets, color, radii, geomBuffer, binningBuffer, imgBuffer, sampleBuffer, accum_metric_per_gs, accum_metric_counts, accum_gs_weight = _C.rasterize_gaussians(*args)
        ...
        return color, radii, accum_metric_per_gs, accum_metric_counts, accum_gs_weight

    @staticmethod
    def backward(ctx, grad_out_color, _, g_metric, g_metric_counts, g_weight):
